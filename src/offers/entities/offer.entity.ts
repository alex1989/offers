...
type OfferBoxSizeEnumType = 'small' | 'large';
const OFFER_BOX_SIZE_SMALL: OfferBoxSizeEnumType = 'small';
const OFFER_BOX_SIZE_LARGE: OfferBoxSizeEnumType = 'large';
const OfferBoxSizeEnum = {
  OFFER_BOX_SIZE_SMALL,
  OFFER_BOX_SIZE_LARGE,
};
